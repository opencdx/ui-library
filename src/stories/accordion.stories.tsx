...
import {Accordion, AccordionProps, AccordionItem, AccordionItemProps} from "@/components/ui/Accordion";
...
const defaultContent =
  "A UI component that displays a list of headers stacked vertically on a page, with each header acting as a control to reveal or hide associated content.";
